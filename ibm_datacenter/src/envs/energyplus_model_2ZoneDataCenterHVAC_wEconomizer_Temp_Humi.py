...
class EnergyPlusModel2ZoneDataCenterHVAC_wEconomizer_Temp_Humi(EnergyPlusModel):
    def __init__(self,
                 model_file,
                 log_dir,
                 verbose=False,
        ...
        super(EnergyPlusModel2ZoneDataCenterHVAC_wEconomizer_Temp_Humi, self).__init__(model_file, log_dir, verbose, normalized, window)
    ...
    def setup_spaces(self):
        ...
        self.action_high = np.array([40.0, 40.0])
